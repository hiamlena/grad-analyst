...
const docs = [
  { name: "ГПЗУ", status: "добавлен", loaded: true, note: "параметры застройки" },
  { name: "Выписка ЕГРН", status: "добавлен", loaded: true, note: "площадь, ВРИ, право" },
  { name: "Схема участка", status: "добавлен", loaded: true, note: "форма, подъезд, размещение" },
  { name: "ПЗЗ / регламент", status: "добавить", loaded: false, note: "для проверки территориальной зоны" },
  { name: "ЗОУИТ", status: "добавить", loaded: false, note: "ограничения и охранные зоны" },
];
...
function PlanSvg() {
  return (
    <svg className="plan-svg" viewBox="0 0 760 430" role="img" aria-label="Схема участка с объектом, парковкой, въездом и отступами">
      ...
      <rect x="28" y="314" width="704" height="48" fill="#cbd5e1" />
      ...
      <rect x="158" y="150" width="178" height="104" rx="18" fill="url(#buildingFill)" stroke="#b7791f" />
...
export default function Home() {
        ...
        <section className="login-card clean-login">
          <div className="login-brand">
            ...
            <div>
              ...
              <small>закрытый аналитический кабинет</small>
            </div>
          </div>
          <h1>Закрытый кабинет предпроектной аналитики</h1>
          <p>Документы, ограничения, предварительный вывод и схема размещения по одному участку.</p>
          <form className="request-form login-form compact-login-form" onSubmit={handleLogin}>
            ...
            <details className="manual-login">
              <summary>Вход по выданному доступу</summary>
  ...
  return (
    <main className="app-shell clean-shell">
        ...
        <section className="section muted-section compact-section">
          <div className="container app-grid">
            ...
            <form className="request-form app-form">
              ...
              <small className="form-note">В рабочей версии данные сохраняются в карточке участка.</small>
            </form>
          </div>
        </section>
      ) : null}
      ...
      {screen === "documents" ? (
        <section className="section compact-section documents-section">
          <div className="container split-section documents-layout">
